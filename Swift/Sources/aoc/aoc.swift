...
struct Aoc: @preconcurrency ParsableCommand, Decodable {
    ...
    @MainActor public func run() throws {
        ...
        case 2025:
            ...
            case 7: Y2025.day07(data)
            case 8: Y2025.day08(data)
            case 9: Y2025.day09(data)
            case 10: Y2025.day10(data)
            case 11: Y2025.day11(data)
            case 12: Y2025.day12(data)
            default: fatalError()
            }
        case 2024:
            switch day {
        ...
        case 2022:
            ...
            case 11: Y2022.day11(data)
            case 12: Y2022.day12(data)
            default: fatalError()
            }
        case 2016:
            switch day {
