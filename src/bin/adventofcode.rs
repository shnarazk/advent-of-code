...
pub fn main() {
    ...
    match year {
        ...
        #[cfg(feature = "y2020")]
        2020 => match day {
            1 => println!("{:?}", y2020::day01::Puzzle::solve(desc, part)),
            2 => println!("{:?}", y2020::day02::Puzzle::solve(desc, part)),
            3 => println!("{:?}", y2020::day03::Puzzle::solve(desc, part)),
            4 => println!("{:?}", y2020::day04::Puzzle::solve(desc, part)),
            5 => println!("{:?}", y2020::day05::Puzzle::solve(desc, part)),
            6 => println!("{:?}", y2020::day06::Puzzle::solve(desc, part)),
            7 => println!("{:?}", y2020::day07::Puzzle::solve(desc, part)),
            8 => println!("{:?}", y2020::day08::Puzzle::solve(desc, part)),
            9 => println!("{:?}", y2020::day09::Puzzle::solve(desc, part)),
            10 => println!("{:?}", y2020::day10::Puzzle::solve(desc, part)),
            11 => println!("{:?}", y2020::day11::Puzzle::solve(desc, part)),
            12 => println!("{:?}", y2020::day12::Puzzle::solve(desc, part)),
            13 => println!("{:?}", y2020::day13::Puzzle::solve(desc, part)),
            14 => println!("{:?}", y2020::day14::Puzzle::solve(desc, part)),
            15 => println!("{:?}", y2020::day15::Puzzle::solve(desc, part)),
            16 => println!("{:?}", y2020::day16::Puzzle::solve(desc, part)),
            17 => println!("{:?}", y2020::day17::Puzzle::solve(desc, part)),
            18 => println!("{:?}", y2020::day18::Puzzle::solve(desc, part)),
            19 => println!("{:?}", y2020::day19::Puzzle::solve(desc, part)),
            20 => println!("{:?}", y2020::day20::Puzzle::solve(desc, part)),
            21 => println!("{:?}", y2020::day21::Puzzle::solve(desc, part)),
            22 => println!("{:?}", y2020::day22::Puzzle::solve(desc, part)),
            23 => println!("{:?}", y2020::day23::Puzzle::solve(desc, part)),
            24 => println!("{:?}", y2020::day24::Puzzle::solve(desc, part)),
            25 => println!("{:?}", y2020::day25::Puzzle::solve(desc, part)),
            _ => println!("{:?}", y2021::template::Puzzle::solve(desc, part)),
        },
        #[cfg(feature = "y2019")]
        2019 => match day {
