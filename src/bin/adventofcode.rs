...
fn run_solver(mut config: ConfigAoC) {
    ...
    match config.year {
        #[cfg(feature = "y2015")]
        2015 => aoc_arms!(2015, 25),
        #[cfg(feature = "y2016")]
        2016 => aoc_arms!(2016, 25),
        #[cfg(feature = "y2017")]
        2017 => aoc_arms!(2017, 25),
        #[cfg(feature = "y2018")]
        2018 => aoc_arms!(2018, 25),
        #[cfg(feature = "y2019")]
        2019 => aoc_arms!(2019, 25),
        #[cfg(feature = "y2020")]
        2020 => aoc_arms!(2020, 25),
        #[cfg(feature = "y2021")]
        2021 => aoc_arms!(2021, 25),
        #[cfg(feature = "y2022")]
        2022 => aoc_arms!(2022, 25),
        #[cfg(feature = "y2023")]
        2023 => aoc_arms!(2023, 25),
        #[cfg(feature = "y2024")]
